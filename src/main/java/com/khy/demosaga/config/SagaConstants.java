...
public class SagaConstants {
    ...
    public static final String SAGA_RESPONSE_TOPIC_ID = "saga-response-listener-id";
    public static final String DISCOUNT_REQUEST_TOPIC = "discount-request-v1";
    public static final String DISCOUNT_REQUEST_TOPIC_ID = "discount-request-listener-id";
    public static final String DISCOUNT_RESPONSE_TOPIC = "discount-response-v1";
    public static final String DISCOUNT_RESPONSE_TOPIC_ID = "discount-response-listener-id";
    public static final String PAYMENT_REQUEST_TOPIC = "payment-request-v1";
    public static final String PAYMENT_REQUEST_TOPIC_ID = "payment-request-listener-id";
    public static final String PAYMENT_RESPONSE_TOPIC= "payment-response-v1";
    public static final String PAYMENT_RESPONSE_TOPIC_ID= "payment-response-listener-id";
